...
import { faSeedling, faWater, faIndustry, faDollarSign, faExchangeAlt, faUtensils } from '@fortawesome/free-solid-svg-icons';
...
const Visualization = ({ section, subsection, scenario, chartType, metric, setMetric, setChartType }) => {
  ...
  const handleYearRangeChange = (percentage) => {
    const totalYears = 2023 - 2014 + 1;
    const yearsToShow = Math.floor(totalYears * (percentage / 100));
    setYearFilter({ start: 2023 - yearsToShow + 1, end: 2023 });
  };
    ...
    <div className="visualization-container">
      ...
      <div className="visualization-buttons">
        <button className="acreage" onClick={() => setMetric('Acreage')}>
          <FontAwesomeIcon icon={faSeedling} /> Acreage
        </button>
        ...
        <button className="consumption" onClick={() => setMetric('Consumption')}>
          <FontAwesomeIcon icon={faUtensils} /> Consumption
        </button>
      </div>
      <div className="visualization-buttons">
      ...
      <div className="visualization-buttons">
        ...
        <select onChange={(e) => handleYearRangeChange(parseInt(e.target.value))}>
